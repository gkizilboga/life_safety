  ...
  group('YGH Zorunluluk Kriterleri Testleri', () {
    ...
    test('Kriter 4: Bodrum kat var ve Bölüm 23 seçimi 23-1-C ise YGH zorunlu olmalı', () {
      ...
      store.bolum23 = Bolum23Model(
        bodrum: ChoiceResult(label: "23-1-C", uiTitle: "", uiSubtitle: "", reportText: ""),
      );
      final reasons = ReportEngine.evaluateYghRequirement(store: store);
      expect(reasons.any((r) => r.contains("Bodrum kata inen")), true);
    });
    ...
    test('Kriter 6: Merdiven bodruma kesintisiz devam ediyorsa (20-Bodrum-A) YGH zorunlu olmalı', () {
      store.bolum3 = Bolum3Model(bodrumKatSayisi: 1, hYapi: 10.0);
      store.bolum20 = Bolum20Model(
        bodrumMerdivenDevami: ChoiceResult(label: "20-Bodrum-A", uiTitle: "", uiSubtitle: "", reportText: ""),
      );
      final reasons = ReportEngine.evaluateYghRequirement(store: store);
      expect(reasons.any((r) => r.contains("kesintisiz devam etmesi")), true);
    });
  });
}