        ...
        return AlertDialog(
          ...
          content: const SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                Text(
                  '⚠️ DİKKAT: Bu uygulamada esas olarak 19.12.2007 ve sonrasında yapı ruhsatı almış binalar hakkında değerlendirme yapılmaktadır.',
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14),
                ),
                SizedBox(height: 10),
                Text(
                  'Binanız belirtilen tarihten önce ruhsat almış olmasına rağmen güncel yönetmelikteki "Yeni Bina" hükümlerine göre analiz edilmesini talep ettiniz. Kesin risk analizi için uzman kontrolü ve görüşü almanız tavsiye edilir.\n\n',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [
          const ModernHeader(
            title: "Bölüm-1: Yapı Ruhsat Tarihi",
            subtitle: " ",
            currentStep: 1,
            totalSteps: 10,
          ),
