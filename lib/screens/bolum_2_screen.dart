...
class _Bolum2ScreenState extends State<Bolum2Screen> {
  ...
  void _onNextPressed() {
    ...
    Navigator.push(context, MaterialPageRoute(builder: (context) => const Bolum3Screen()));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          ModernHeader(
            title: "Bina Kullanım Sınıfı",
            subtitle: "Binanın ana fonksiyonel amacını belirleyin",
