...
class ScopeScreen extends StatelessWidget {
  ...
  static const List<Map<String, String>> scopeFaqs = [
    ...
    },
    {
      ...
      'a':
          'Raporlardaki kırmızı (Kritik Risk / Zorunlu), sarı (Uyarı / Önerilen) ve yeşil (Olumlu) renkler, o konudaki risk veya gereklilik seviyesini gösterir. Puanlar ve değerlendirmeler yalnızca bu uygulama içindeki göreli bir ön değerlendirmedir; resmi belge veya sertifika niteliği taşımaz.',
    },
    {
      'q': 'Periyodik Testler ve Bakım zorunlu mu?',
      'a':
          'Evet. Kurulumu yapılan yangın alarm, sprinkler, duman tahliye, acil aydınlatma ve söndürme sistemlerinin Binaların Yangından Korunması Hakkında Yönetmeliği ve ilgili TS EN standartları çerçevesinde yetkili servis kuruluşlarınca yılda en az bir kez periyodik test ve bakımlarının yapılması yasal zorunluluktur. Yangın tüpleri ve yangın dolapları için ise 6 ayda bir kontrol önerilir. Bu sorumluluk bina yönetimine aittir.',
    },
    {
    ...
    },
    {
      'q': 'Önemli Uyarı',
      'a':
          'Bu uygulama bir "ön değerlendirme" aracıdır ve binanızdaki tüm riskleri eksiksiz tespit edemez. Kesin ve resmi güvenlik analizi ile sistem tespiti için yetkin bir Yangın Mühendisi tarafından proje ve saha üzerinde yerinde inceleme yapılması şarttır.',
    },
  ];
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  ...
                  child: Theme(
                    ...
                    child: ExpansionTile(
                      initiallyExpanded: index == 0 || isWarning, // Hangi binalar ve Önemli uyarı default açık olsun
                      leading: Container(
                        ...
                        child: Icon(
                          isWarning ? Icons.warning_amber_rounded : Icons.help_outline_rounded,
                      ...
                      iconColor: isWarning ? const Color(0xFFD84315) : const Color(0xFF1a365d),
                      collapsedIconColor: isWarning ? const Color(0xFFFFA000) : Colors.grey,
                      children: [
                        Padding(
