    ...
    const faqs = [
      {
        ...
        'a': 'Bu uygulama yalnızca 19.12.2007 tarihinden sonra yapı ruhsatı onaylanmış KONUT amaçlı yapılar için geçerlidir. Binanın merdivenleri, kaçış yolları ve kapıları gibi yapısal (mimari) özellikleri ile elektromekanik yangın güvenliği ihtiyaçları analiz edilmektedir.',
      },
      {
    ...
    return Container(
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          ...
          leading: const Icon(Icons.info_outline_rounded, color: Color(0xFF1a365d), size: 22),
          title: const Text(
            "Kapsam ve Sık Sorulan Sorular",
            style: TextStyle(
              fontWeight: FontWeight.w700,
              fontSize: 14,
