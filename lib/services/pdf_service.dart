...
class PdfService {
  ...
  static PdfColor _getRiskColor(String text) {
    if (text.contains("KRİTİK RİSK") || text.contains("RİSK"))
            ...
            children: [
              ...
              pw.Column(
                ...
                children: [
                  ...
                  _buildInfoRow(
                    "Konum:",
                    "${store.currentBinaCity} / ${store.currentBinaDistrict}",
                  ),
                  _buildInfoRow(
                    "Analiz Tarihi:",
                  ...
                  _buildInfoRow(
                    "Yangın Güvenlik Skoru:",
                    "%${metrics['score']}",
                  ),
                ],
              ),
              pw.Text(
                "İşbu rapor kullanıcı beyanına dayalı bir ön analizdir.",
              ...
              pw.Container(
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    pw.SizedBox(height: 5),
                    pw.Text(
                      "Detaylı saha incelemesi ve raporlama hizmetleri için Yangın Güvenlik Uzmanı 'yla WhatsApp üzerinden iletişime geçebilirsiniz.",
                      style: const pw.TextStyle(fontSize: 9),
                    ),
                  ],
                ),
