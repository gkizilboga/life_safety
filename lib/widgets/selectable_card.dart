...
import 'custom_widgets.dart' show ImageModalHelper, DefinitionButton;
...
class SelectableCard extends StatelessWidget {
  ...
  final String? infoTerm;
  final String? infoDefinition;
      ...
      child: AnimatedContainer(
        ...
        child: Row(
          children: [
            ...
            // Option-level info icon (Question Mark)
            if (infoDefinition != null) ...[
              const SizedBox(width: 8),
              DefinitionButton(
                term: infoTerm ?? choice.uiTitle,
