...
class Bolum1Content {
 ...
 static final ruhsatOncesi = ChoiceResult(
  ...
  reportText:
        "BİLGİ: Bina, ruhsat tarihi itibarıyla \"Mevcut Bina\"statüsünde olmasına rağmen, kullanıcı talebi üzerine güncel yönetmeliğin \"YENİ BİNA\"standartlarına göre değerlendirilmiştir. MEVCUT BİNA 'nın yangın güvenlik gereksinimleri Yangın Yönetmeliği 'nde YENİ BİNA 'ya göre daha esnek ve daha hafiftir. Bu sebeple MEVCUT BİNA için Yangın Güvenlik Uzmanı tarafından hususi değerlendirme yapılması önerilir. ",
 );
}
...
class Bolum2Content {
 ...
 static final ahsap = ChoiceResult(
  ...
  reportText:
        "BİLGİ:Binanın taşıyıcı sistemi AHŞAP olarak beyan edilmiştir. Ahşap yapıların yangın dayanımı, kullanılan kesitlerin kalınlığına (kömürleşme hızına) bağlı olarak değerlendirilmiştir.",
 );
 ...
 static final bilinmiyor = ChoiceResult(
  ...
  reportText:
        "BİLGİ: Binanın taşıyıcı sistemi net olarak bilinmemektedir. Türkiye'deki yapı stoğunun büyük çoğunluğu betonarme olduğu için analiz BETONARME varsayımıyla yapılmıştır. Kesin sonuç için statik proje incelenmelidir.",
 );
}
...
class Bolum3Content {
 static final biliniyor = ChoiceResult(
  ...
  reportText:
        "BİLGİ:Bina yükseklik analizi beyan edilen değerler üzerinden yapılmıştır.",
 );
 ...
 static final bilinmiyor = ChoiceResult(
  ...
  reportText:
        "BİLGİ: Kat yükseklikleri bilinmediği için standart mühendislik değerleri kullanılmıştır.",
 );
}
...
class Bolum5Content {
 ...
 static final otomatikHesap = ChoiceResult(
  ...
  reportText:
        "BİLGİ: Toplam inşaat alanı sistem tarafından otomatik hesaplanmıştır.",
 );
}
...
class Bolum6Content {
 ...
 static final ticariVar = ChoiceResult(
  ...
  reportText:
        "BİLGİ: Binada konut harici ticari kullanım (işyerleri vb.) mevcuttur. Karma kullanımlı binalarda, ticari alanların konutlardan yangın duvarı ile ayrılması önerilmektedir.",
 );
 ...
 static final depoVar = ChoiceResult(
  ...
  reportText:
        "BİLGİ: Binada konutlara ait ortak depo alanı bulunmaktadır. Depolanan malzemeler yangın yükleri sebebiyle risk oluşturur.",
 );
...
class Bolum7Content {
 ...
 static final otopark = ChoiceResult(
  ...
  reportText:
        "Bölüm 6'dan gelen bilgiye göre rapora eklenmiştir.",
 );
 ...
 static final kazan = ChoiceResult(
  ...
  reportText:
        "BİLGİ: Binada kazan dairesi mevcuttur. Basınçlı ekipmanlar ve yakıt sebebiyle binadaki yüksek riskli alanlarından biridir. Kazan dairesi 120 dk yangın dayanımlı duvarlarla ayrılmalıdır.",
 );
 ...
 static final cop = ChoiceResult(
  ...
  reportText:
        "BİLGİ: Çöp odası mevcuttur. Biriken çöplerden çıkan metan gazı yanıcıdır. Havalandırma şarttır.",
 );
 ...
 static final siginak = ChoiceResult(
  ...
  reportText:
        "BİLGİ: Binada sığınak mevcuttur. Barış zamanında depo olarak kullanılsa bile yanıcı madde konulamaz.",
 );
...
class Bolum9Content {
 ...
 static final yok = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLGİ: Binanın hiçbir yerinde otomatik yağmurlama (sprinkler) sistemi bulunmamaktadır. Bu durumda kaçış mesafesi limitleri minimum değerler üzerinden değerlendirilmektedir. Sprinkler sistemi olmaması kaçış mesafeleri ve can güvenliği açısından büyük dezavantaj yaratır. Yangın Yönetmeliği-Madde 96 'ya göre belli özelliklerdeki konutlarda, otoparklarda, ticari amaçlı kısımlarda otomatik söndürme sistemi mecburiyeti doğabilmektedir.",
 );
 ...
 static final kismen = ChoiceResult(
  ...
  reportText:
        "BİLGİ: Sprinkler sistemi binada kısmi olarak bulunuyor. Yönetmelik gereği, kaçış güvenliği hesaplarında sistemin \"YOK\"olduğu varsayılacaktır. Sprinkler sisteminin tüm mahallerde veya katlarda olmaması kaçış mesafeleri ve can güvenliği açısından dezavantaj yaratır.",
 );
}
...
class Bolum10Content {
 static final konut = ChoiceResult(
  ...
  reportText:
        "(Hesaplamada kullanılır: 20 m²/kişi)",
 );
 ...
 static final azYogunTicari = ChoiceResult(
  ...
  reportText:
        "(Hesaplamada kullanılır: 10 m²/kişi)",
 );
 ...
 static final ortaYogunTicari = ChoiceResult(
  ...
  reportText:
        "(Hesaplamada kullanılır: 5 m²/kişi)",
 );
 ...
 static final yuksekYogunTicari = ChoiceResult(
  ...
  reportText:
        "(Hesaplamada kullanılır: 1.5 m²/kişi)",
 );
 ...
 static final teknikDepo = ChoiceResult(
  ...
  reportText:
        "(Hesaplamada kullanılır: 30 m²/kişi)",
 );
}
...
class Bolum11Content {
 ...
 static final mesafeOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: İtfaiye yaklaşım mesafesi yeterli (tüm cepheler 45 metre menzil içerisinde). Bu konunun yanısıra itfaiyenin manevra yapabileceği alanın yeterli olup olmadığı kontrol edilmelidir.",
 );
 ...
 static final mesafeOptionB = ChoiceResult(
  ...
  reportText:
        "KRİTİK RİSK: İtfaiye yaklaşım mesafesi sınırın üzerindedir. Yönetmeliğe göre itfaiye aracı, binanın her cephesine (arka cepheler dahil) en fazla 45 metre mesafede yaklaşabilmelidir. Mevcut durumda binanın bazı cephelerine müdahale edilemeyebilir. Bu konunun yanısıra itfaiyenin manevra yapabileceği alanın yeterli olup olmadığı kontrol edilmelidir.",
 );
 ...
 static final engelOptionB = ChoiceResult(
  ...
  reportText:
        "KRİTİK RİSK: İtfaiye erişimini zorlaştıran fiziksel engeller (duvar, kapı vs.) tespit edilmiştir.",
 );
 ...
 static final engelOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "UYARI: Mesafenin aşılmasının sebebinin duvar olup olmadığı bilinmiyor. Kontrol edilmesi ve Uzman Görüşü alınması tavsiye edilir.",
 );
...
class Bolum12Content {
 ...
 static final celikOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Çelik elemanlarda yangın koruması olup olmadığı bilinmiyor. Koruma yoksa, yangın anında bina taşıma kapasitesini hızla kaybedebilir.",
 );
 ...
 static final betonOptionB = ChoiceResult(
  ...
  reportText:
        "(Girilen değerlere göre otomatik analiz edilir)",
 );
 ...
 static final betonOptionD = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Paspayı kalınlığı bilinmediği için yapısal yangın dayanım tahmini yapılamamıştır. Uzman incelemesi tavsiye edilir.",
 );
...
class Bolum13Content {
 static final otoparkOptionA = ChoiceResult(
  ...
  uiTitle:
    "Yangına dayanıklı, duman sızdırmaz, kendiliğinden kapanan yangın kapısı bulunuyor.",
  uiSubtitle: "",
  reportText:
 ...
 static final otoparkOptionB = ChoiceResult(
  ...
  uiTitle:
    "Yangına dayanıksız sac, demir, plastik, aluminyum, ahşap vb. kapı bulunuyor.",
  uiSubtitle: "",
  reportText:
 ...
 static final otoparkOptionC = ChoiceResult(
  ...
  reportText:
        "KRİTİK RİSK: Otopark ile bina arasında kompartıman ayrımı yoktur. Bir araç yangınında duman doğrudan binanın içine dolarak tüm kaçış yollarını kullanılamaz hale getirebilir. angın duvarı ve kapısı ile ayrım yapılmalıdır.",
 );
 ...
 static final otoparkOptionD = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Otopark kapısının teknik özellikleri bilinmiyor. Kapı yangına dayanıklı olmalıdır. Geçiş noktasıyla ilgili Uzman Görüşü alınması tavsiye edilir.",
 );
 ...
 static final kazanOptionD = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Kazan dairesinin duvar ve kapı özellikleri bilinmiyor. Özellikle bina içerisinde yer alan kazan dairesindeki yangın güvenlik önlemleri hayati önem taşır, Uzman Görüşü alınması tavsiye edilir.",
 );
 ...
 static final asansorOptionB = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "UYARI: Asansör kat / kabin kapıları yangına dayanıklı değildir. Makine daireleri yangın riski taşır, kapı dayanıklı olmalıdır.",
 );
 ...
 static final asansorOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Kapı özellikleri bilinmiyor, duvarlarıyla birlikte kapısının da yangına dayanıklı olması gereklidir. Kapıların test raporu incelenerek uygunluklarına karar verilir.",
 );
 ...
 static final jeneratorOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Jeneratör odası yangına dayanıklı duvar ve kapı ile ayrılmıştır. Oda kapısının test raporu Uzman tarafından incelenerek uygunluğuna karar verilir.",
 );
 ...
 static final jeneratorOptionB = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "KRİTİK RİSK: Jeneratör yakıtı risklidir, bu mahal yangın dayanımlı duvar ve yangın kapısı ile binanında geri kalanından ayrılmalıdır.",
 );
 ...
 static final jeneratorOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Jeneratör odası özellikleri bilinmiyor. Jeneratör yakıtı risklidir, bu mahal yangın dayanımlı duvar ve yangın kapısı ile binanında geri kalanından ayrılmalıdır. Oda kapısının test raporu Uzman tarafından incelenerek uygunluğuna karar verilir.",
 );
 ...
 static final elekOdasiOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Elektrik odası yangına dayanıklı ve duman sızdırmaz kapı ile korunmaktadır. Oda kapısının test raporu Uzman tarafından incelenerek uygunluğuna karar verilir.",
 );
 ...
 static final elekOdasiOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Elektrik odalarının duvarları ve kapıları yangın dayanım özellikli olmalıdır. Oda kapısının test raporu Uzman tarafından incelenerek uygunluğuna karar verilir.",
 );
 ...
 static final trafoOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Trafo odasının kapısı kilitli, yangına dayanıklı ve duman sızdırmaz özelliklidir.Yağlı tip trafo kullanılıyorsa oda kapısının test raporu Uzman tarafından incelenerek uygunluğuna karar verilir..",
 );
 ...
 static final trafoOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Yağlı tip trafo odalarının duvarları ve kapıları yangın dayanım özellikli olmalıdır. Uzman Görüşü alınarak kapı tipi teyit edilmelidir.",
 );
 ...
 static final depoOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Kapı durumu bilinmiyor. Depolarda duman sızdırmazlığı önemlidir. Depo kapısının test raporu Uzman tarafından incelenerek uygunluğuna karar verilir.",
 );
 ...
 static final copOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Çöp odalarının duvarları ve kapıları yangın dayanım özellikli olmalıdır. Oda kapısının test raporu Uzman tarafından incelenerek uygunluğuna karar verilir.",
 );
 ...
 static final ortakDuvarOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Bitişik nizam bina ile aradaki duvarın kalınlığı bilinmiyor. Duvarın 90 dk dayanım gösterecek özellikte olması şarttır. Uzman Görüşü alınması tavsiye edilir.",
 );
 ...
 static final ticariOptionB = ChoiceResult(
  ...
  reportText:
        "(Alt soruya göre belirlenir) Hayır ise: KRİTİK RİSK: Farklı kullanımlar yangın kompartımanı ile ayrılmalıdır.",
 );
 ...
 static final ticariOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Farklı kullanım alanlarındaki geçiş bilinmiyor, Uzman Görüşü alınması tavsiye edilir.",
 );
...
class Bolum15Content {
 ...
 static final kaplamaOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Zemin kaplamasının yanıcılık sınıfı bilinmiyor.Yönetmelik gereği yüksek binalarda döşeme kaplamalarının en az zor alevlenici olması gerekmektedir; aksi durumda yanıcı kaplamalar risk teşkil eder.",
 );
 ...
 static final yalitimOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Zemin altında yanıcı yalıtım malzemesi olup olmadığı bilinmiyor. Mimari proje üzerinden kontrol edilmelidir.",
 );
 ...
 static final yalitimSapOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Yanıcı yalıtım şap ile korunmuştur.",
 );
 ...
 static final yalitimSapOptionB = ChoiceResult(
  ...
  reportText:
        "KRİTİK RİSK: Yalıtımın üzeri en az 2 cm şap ile örtülmelidir.",
 );
 ...
 static final yalitimSapOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "UYARI: Koruyucu şap tabakası olup olmadığı bilinmiyor.",
 );
 ...
 static final tavanOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Tavanlarda asma tavan bulunmamaktadır.",
 );
 ...
 static final tavanOptionB = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "UYARI: Asma tavan malzemesi kontrol edilmelidir.",
 );
 ...
 static final tavanOptionD = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Tavan yapısı hakkında bilgi yok. Binadaki tavan tiplerinin incelenmesi gereklidir.",
 );
 ...
 static final tavanMalzemeOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Asma tavan malzemesinin yanıcılığı bilinmiyor. Asma tavan malzemelerinin yangına tepki test raporları kontrol edildikten sonra Yönetmelik şartlarını karşılayıp karşılamadığına karar verilir.",
 );
 ...
 static final tesisatOptionD = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Tesisat şaft yalıtımı bilinmiyor. Binadaki özellikle yangın kompartımanları, döşeme ve şaftlardaki tesisat geçişleri ve kullanılan malzemelerin akredite test raporları veya onay dokümanları kontrol edilerek uygunluklarına karar verilir.",
 );
}
...
class Bolum16Content {
 ...
 static final mantolamaOptionE = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Dış cephe malzemesi bilinmiyor. Yüksek binalarda yanıcı malzeme kullanımı hayati risk taşır. Malzemelerin test raporları sorgulanmalıdır.",
 );
 ...
 static final bitisikOptionD = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Bitişik bina ile yükseklik durumu bilinmiyor. Eğer yan binadan yüksekseniz, o bölgedeki cephe malzemesinin yangına tepki sınıfı kritik öneme sahiptir.",
 );
}
...
class Bolum17Content {
 ...
 static final kaplamaOptionF = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Çatı kaplama malzemesi bilinmiyor. Yanıcı bir malzeme (shingle, plastik vb.) kullanıldıysa tüm bina risk altındadır. Uzman Görüşü alınması tavsiye edilir.",
 );
 ...
 static final iskeletOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Çatı iskeletinin durumu bilinmiyor. Yüksek binalarda ahşap çatı büyük risk taşır. Uzman Görüşü alınması tavsiye edilir.",
 );
 ...
 static final bitisikOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Komşu bina ile çatı birleşim detayı bilinmiyor. Binanıza yangın sıçrama riski olabilir.",
 );
 ...
 static final isiklikOptionB = ChoiceResult(
  ...
  reportText:
        "(Alt soruya göre belirlenir)<br>Cam: OLUMLU: Temperli cam ışıklıklar yeterli olabilir<br>Plastik: UYARI: Çatı ışıklıklarında kullanılan plastik malzemeler yangında eriyip aşağıya damlayarak yangını içeri taşıyabilir.",
 );
 static final isiklikOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Çatı ışıklık durumu bilinmiyor. Işıklık varsa ve plastikse yangın riski oluşturabilir. Uzman kontrolü önerilir.",
 );
}
...
class Bolum18Content {
 static final duvarOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Duvar yüzeylerinde yanıcı kaplama bulunmamaktadır.",
 );
 ...
 static final duvarOptionD = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Duvar kaplama malzemesi bilinmiyor. 21.50m üzeri binalarda yanıcı kaplama malzemesi kullanımı büyük risk taşır.",
 );
 ...
 static final boruOptionC = ChoiceResult(
  ...
  reportText:
        "UYARI: 21.50m ve üzeri binalarda standart plastik borular yangın anında eriyerek yok olur ve döşemede delik açılır. Bu delikten alevler üst kata geçer. Yangın Kelepçesi ZORUNLUDUR.",
 );
 ...
 static final boruOptionD = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Tesisat borularının yangın dayanımı veya malzeme özellikleri bilinmiyor. Yüksek binalarda plastik boruların kat geçişlerinde (döşemelerinde) yangın kesici (kelepçe) olup olmadığı hayati önem taşır.",
 );
}
...
class Bolum19Content {
 ...
 static final engelOptionC = ChoiceResult(
  ...
  reportText:
        "KRİTİK RİSK: Kaçış yolunda kilitli kapı veya fiziksel engel mevcuttur.",
 );
 ...
 static final levhaOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Acil durum yönlendirme işaretleri mevcuttur.",
 );
 ...
 static final etiketOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Yanıltıcı kapıların işaretleme durumu tespit edilememiştir.",
 );
}
...
class Bolum20Content {
 ...
 static final basYghOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Merdiven basınçlandırma durumu belirsizdir.",
 );
 ...
 static final bodrumOptionA = ChoiceResult(
  ...
  reportText:
        "(Bodrum çıkış sayısı hesabında kullanılır)",
 );
 ...
 static final rampaOptionC = ChoiceResult(
  ...
  reportText:
        "(Merdiven sayısı not edilir) Çıkışta basamak mevcuttur.",
 );
}
...
class Bolum21Content {
 ...
 static final varlikOptionB = ChoiceResult(
  ...
  reportText:
        "BİLGİ: Binada YGH bulunmamaktadır.",
  adviceText:
 ...
 static final malzemeOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: YGH içindeki kaplamalar yanmaz özelliktedir.",
 );
 ...
 static final malzemeOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Holdeki malzemelerin yanıcılık özellikleri bilinmiyor. Kaçış yollarında yanıcı malzeme kullanımı risk teşkil eder.",
 );
 ...
 static final kapiOptionA = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "OLUMLU: YGH kapıları uygun gözükmektedir.",
 );
 ...
 static final kapiOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: kapıların yangın dayanımı bilinmiyor. YGH kapıları en az 90 dakika yangına dayanıklı olmalıdır.",
 );
 ...
 static final esyaOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: YGH içi temiz ve boş olduğundan güvenli sayılır.",
 );
...
class Bolum22Content {
 ...
 static final varlikOptionB = ChoiceResult(
  ...
  reportText:
        "BİLGİ: Binada itfaiye asansörü mevcuttur.",
 );
 ...
 static final varlikOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Binada itfaiye asansörü varlığı teyit edilememiştir. Yapı yüksekliği 51.50 metreyi geçen binalarda bu donanım zorunludur.",
 );
 ...
 static final konumOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: İtfaiye asansörünün açıldığı mahal belirsizdir. Güvenli tahliye ve müdahale için asansörün yangın güvenlik holüne açılması şarttır.",
 );
 ...
 static final boyutOptionD = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: İtfaiye asansörü önündeki holün boyutları teyit edilememiştir. Alanın 6 ila 10 m² arasında olması idealdir.",
 );
 ...
 static final kabinOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: İtfaiye asansörünün kabin ölçüleri ve hızı bilinmemektedir.",
 );
 ...
 static final enerjiOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: İtfaiye asansörünün jeneratör desteği olup olmadığı teyit edilememiştir.",
 );
 ...
 static final basincOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: İtfaiye asansör kuyusunun basınçlandırma durumu bilinmemektedir.",
 );
}
...
class Bolum23Content {
 static final bodrumOptionA = ChoiceResult(
  ...
  reportText:
        "Bilgi: Asansör bodrum katlara inmemektedir.",
 );
 ...
 static final bodrumOptionD = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Bodrum katlardaki asansörlerin hemen önünde mutlaka 'Yangın Güvenlik Holü'olmalıdır. Mevcut durum bilinmiyor.",
 );
 ...
 static final yanginModuOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Asansörün yangın senaryosu bilinmiyor. Yangın anında asansörde mahsur kalmamak için bu özelliğin varlığı hayati önem taşır.",
 );
 ...
 static final konumOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Asansör kapısının konumu net değil. Eğer yangın merdiveni içine açılıyorsa, kaçış yolunuz tehlike altındadır.",
 );
 ...
 static final levhaOptionA = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "OLUMLU: Asansörlerde gerekli uyarı levhaları mevcuttur.",
 );
 ...
 static final levhaOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Uyarı levhalarının varlığı bilinmiyor. Panik anında insanlar refleks olarak asansöre yönelebilir. Bu levha, insanları merdivene yönlendirmek için yasal zorunluluktur.",
 );
 ...
 static final havalandirmaOptionA = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "OLUMLU: Asansör kuyusunda duman tahliye bacası mevcuttur.",
 );
 ...
 static final havalandirmaOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Kuyu havalandırması bilinmiyor. Asansör kuyusuna sızan dumanın tahliye edilmesi için en üst noktada 'Duman Tahliye Bacası'(0.1 m²'den az olmamak kaydıyla) zorunludur.",
 );
}
...
class Bolum24Content {
 ...
 static final tipOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Binadan çıkışta dış kaçış geçidi (açık koridor) olup olmadığı tespit edilememiştir. Uzman kontrolü önerilir.",
 );
 ...
 static final pencereOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Açık koridora bakan pencere bulunmamaktadır.",
 );
 ...
 static final pencereOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Dış kaçış geçidine bakan pencerelerin varlığı veya yüksekliği bilinmiyor. Bu pencereler yangın anında kaçış yolunu dumanla doldurabilir.",
 );
 ...
 static final kapiOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Dış kaçış geçidine açılan kapıların yangın dayanımı ve sızdırmazlık özellikleri bilinmiyor.",
 );
}
...
class Bolum25Content {
 ...
 static final genislikOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Dairesel (döner) merdiven genişliği tespit edilememiştir. Genişliğin 100 cm altında olması veya kullanıcı yükünün 25 kişiyi aşması durumunda bu merdiven kaçış yolu sayılamaz.",
 );
 ...
 static final basamakOptionB = ChoiceResult(
  ...
  reportText:
        "KRİTİK RİSK: Döner merdiven basamak genişliği yetersizdir. Dar basamaklar tahliye sırasında düşme riski oluşturur.",
  adviceText:
 ...
 static final basamakOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Döner merdiven basamak genişliği bilinmemektedir.",
 );
 ...
 static final basKurtarmaOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Baş kurtarma yüksekliği yeterli seviyededir.",
 );
 ...
 static final basKurtarmaOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Baş kurtarma yüksekliği tespit edilememiştir.",
 );
}
...
class Bolum26Content {
 ...
 static final varlikOptionB = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "UYARI: Binada kaçış rampası tespit edilmiştir. Eğim ve sahanlık kriterleri analiz edilmelidir.",
 );
 ...
 static final varlikOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Binada kaçış rampası olup olmadığı veya konumu tespit edilememiştir.",
 );
 ...
 static final egimOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Rampa eğimi ve zemin kaymazlık durumu bilinmiyor. %10 üzerindeki eğimler tahliyeyi tehlikeye atar.",
 );
 ...
 static final sahanlikOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Rampa sahanlıklarının varlığı ve kapı önü düzlükleri bilinmiyor.",
 );
 ...
 static final otoparkOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Otopark rampasının kaçış yolu olarak kullanılabilirliği belirsizdir.",
 );
}
...
class Bolum27Content {
 ...
 static final boyutOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Kapı ölçüleri ve eşik durumu bilinmiyor. Dar kapılar ve eşikler panik anında yığılmalara neden olabilir.",
 );
 ...
 static final yonOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Kapı açılış yönü (kaçış yönü) doğrudur.",
 );
 ...
 static final yonOptionE = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Kapı açılma yönü ve kapı tipleri bilinmiyor. Yerinde inceleme yapılarak kaçış yolu üzerindeki kapıların özellikleri hususi olarak kontrol edilmelidir.",
 );
 ...
 static final kilitOptionE = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Kilit mekanizması kontrol edilmelidir. Kilitli kapılar can kaybına neden olabilir. Kaçış güzergahında karma kilit sistemleri mevcuttur. Kullanıcı yükü 100 kişiyi aşan binalarda tüm kapıların panik bar ile donatılması şarttır.",
 );
 ...
 static final dayanimOptionE = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Kaçış yolu üzerindeki kapıların özellikleri bilinmiyor. Uzman tarafından yerinde inceleme yapılması önerilir.",
 );
}
...
class Bolum28Content {
 ...
 static final mesafeOptionB = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "(Sprinkler Varsa) OLUMLU: Sprinkler sistemi olduğu için 30 metreye kadar izin verilir.<br>(Sprinkler Yoksa) KRİTİK RİSK: Sprinkler olmayan dairelerde en uzak noktadan çıkışa mesafe 20 metreyi geçemez.",
 );
 ...
 static final dubleksOptionA = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "OLUMLU: Tek katlı daire olduğu beyan edilmiştir.",
 );
...
class Bolum29Content {
 ...
 static final otoparkOptionB = ChoiceResult(
  ...
  reportText:
        "UYARI: Otoparklar sadece araç parkı içindir. Eşya yığınları yangını büyütür ve söndürmeyi zorlaştırır. Derhal temizlenmelidir.",
 );
 static final otoparkOptionC = ChoiceResult(
  label: "29-1-C",
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Otoparkın temizlik durumu bilinmiyor. Araçların yanına istiflenen eski lastikler veya eşyalar, küçük bir araç yangınını tüm binayı saracak bir felakete dönüştürebilir. Lütfen otoparkı kontrol ediniz.",
 );
 ...
 static final kazanOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Kazan dairesinin içi bilinmiyor. Burası binanın kalbidir ve en yüksek yangın riskini taşır. İçeride unutulan bir bez parçası veya kağıt yığını büyük bir patlamaya neden olabilir. Mutlaka denetlenmelidir.",
 );
 ...
 static final catiOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Çatı arası temiz ve güvenlidir.",
 );
 ...
 static final catiOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Çatı arasının durumu bilinmiyor. Genellikle fazla eşyaların biriktirildiği yerdir. Elektrik tesisatından çıkabilecek bir kıvılcım, buradaki kuru ve tozlu eşyaları anında tutuşturur. Kontrol edilmesi hayati önem taşır.",
 );
 ...
 static final asansorOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Asansör makine dairesi temizdir.",
 );
 static final asansorOptionB = ChoiceResult(
  label: "29-4-B",
  ...
  reportText:
        "UYARI: Asansör motorları ısınır. Yanındaki yağlı bezler veya malzemeler tutuşabilir. Makine dairesi depo olarak kullanılamaz.",
 );
 static final asansorOptionC = ChoiceResult(
  label: "29-4-C",
  uiTitle: "Bilmiyorum.",
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Asansör makine dairesinin durumu bilinmiyor. Motorların ısınmasıyla yanabilecek yağlı bezler veya plastik malzemeler burada büyük risk oluşturur. Yöneticiden bilgi alınız.",
 );
 ...
 static final jeneratorOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Jeneratör odası temizdir.",
 );
 static final jeneratorOptionB = ChoiceResult(
  label: "29-5-B",
  uiTitle: "Evet.",
 ...
 static final jeneratorOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Jeneratör odasının durumu bilinmiyor. İçeride yakıt buharı olabilir. Depolanan gereksiz eşyalar havalandırmayı tıkayabilir veya yangın yükünü artırabilir. Uzman kontrolü önerilir.",
 );
 ...
 static final panoOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Elektrik pano odası temizdir.",
 );
 ...
 static final panoOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Elektrik odasının içi bilinmiyor. Pano odaları yangınların en sık başladığı yerlerdir. İçeride unutulan bir paspas veya kağıt parçası, küçük bir ark (kıvılcım) sonucu büyük bir yangını başlatabilir.",
 );
 ...
 static final trafoOptionA = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "OLUMLU: Trafo odası havalandırılıyor ve temiz tutuluyor.",
 );
 static final trafoOptionB = ChoiceResult(
  label: "29-7-B",
  ...
  uiSubtitle: "",
  reportText:
        "UYARI: Trafo odaları ısınır ve patlama riski taşır. Havalandırma asla kapatılmamalı ve içerisi depo yapılmamalıdır.",
 );
 static final trafoOptionC = ChoiceResult(
  label: "29-7-C",
  uiTitle: "Bilmiyorum.",
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Trafo odasının durumu bilinmiyor. Yüksek gerilim hattı taşıyan bu odaların havalandırmasının kapanması veya içeride eşya olması patlama riskini doğurur. Acilen kontrol edilmelidir.",
 );
 ...
 static final depoOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Depolarda parlayıcı madde tespit edilmemiştir.",
 );
 static final depoOptionB = ChoiceResult(
  label: "29-8-B",
 ...
 static final depoOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Depolarda ne saklandığı bilinmiyor. Komşularınızın buraya koyduğu tiner, boya veya LPG tüpü gibi malzemeler tüm binayı riske atabilir. Depo denetimi yapılmalıdır.",
 );
 ...
 static final copOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Çöp odası temizliği uygun gözüküyor.",
 );
 static final copOptionB = ChoiceResult(
  label: "29-9-B",
  ...
  reportText:
        "UYARI: Biriken çöpler metan gazı oluşturur ve kendiliğinden yanabilir. Günlük temizlik şarttır.",
 );
 static final copOptionC = ChoiceResult(
  label: "29-9-C",
  uiTitle: "Bilmiyorum.",
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Çöp odasının hijyen durumu bilinmiyor. Biriken çöplerden sızan metan gazı, kapalı alanda patlama veya zehirlenme riski oluşturur. Havalandırma ve temizlik kontrol edilmelidir.",
 );
 ...
 static final siginakOptionA = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "OLUMLU: Sığınakta yanıcı madde depolanmamaktadır.",
 );
 static final siginakOptionB = ChoiceResult(
  ...
  reportText:
        "UYARI: Sığınaklar barış zamanında depo olarak kullanılabilir ANCAK yanıcı madde konulamaz. Yangın yükünü artırır.",
 );
 static final siginakOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Sığınağın kullanım durumu bilinmiyor. Kontrolsüzce yığılan eşyalar, sığınağı güvenli bir alan olmaktan çıkarabilir. Kontrol edilmesi tavsiye edilir.",
 );
}
...
class Bolum30Content {
 ...
 static final konumOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Kazan dairesi kapısı koridora açılmaktadır.",
 );
 static final konumOptionB = ChoiceResult(
  label: "30-1-B",
 ...
 static final konumOptionC = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Kazan dairesi bina dışındadır.",
 );
 static final konumOptionD = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Kazan dairesinin konumu ve kapı açılış yönü bilinmiyor. Yangın anında müdahale ve tahliye güvenliği için bu alanın denetlenmesi önerilir.",
 );
 ...
 static final kapasiteBilinmiyorOption = ChoiceResult(
  ...
  reportText:
        "UYARI: Kazan dairesinin ısıl kapasitesi eğer 350kw 'ın üzerindeyse çift çıkış kapısı gereklidir.",
 );
 ...
 static final kapiOptionB = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Kazan dairesinde birden fazla çıkış mevcuttur.",
 );
 static final kapiOptionC = ChoiceResult(
  label: "30-3-C",
  uiTitle: "Bilmiyorum.",
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Kazan dairesi çıkış kapısı sayısı bilinmiyor. Büyük kapasiteli kazanlarda acil durum tahliyesi için en az 2 çıkış şarttır.",
 );
 ...
 static final havaOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Havalandırma durumu bilinmiyor. Yetersiz havalandırma, yanma verimini düşürür ve patlama riski oluşturur.",
 );
 ...
 static final yakitOptionA = ChoiceResult(
  ...
  reportText:
        "BİLGİ: Kazan yakıtı sıvı yakıt (mazot vb.) değildir.",
 );
 ...
 static final yakitOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Yakıt türü bilinmiyor. Yakıt türüne göre alınması gereken özel önlemler (drenaj, söndürme sistemi vb.) belirlenememiştir.",
 );
 ...
 static final drenajOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Sıvı yakıtlı kazanda drenaj sistemi mevcuttur.",
 );
 ...
 static final drenajOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Sıvı yakıtlı kazanlarda sızıntı önleme (drenaj) sistemi olup olmadığı bilinmiyor.",
 );
 ...
 static final tupOptionB = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "OLUMLU: Yangın söndürme ekipmanları tamdır.",
 );
 ...
 static final tupOptionD = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Söndürme ekipmanlarının varlığı bilinmiyor. Kazan dairesinde en az 1 adet 6 kg'lık tüp bulunması şarttır.",
 );
}
...
class Bolum31Content {
 ...
 static final yapiOptionD = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Trafo odasının yapısal özellikleri (duvar/kapı) tespit edilememiştir. Yangın güvenliği açısından bu alanın kompartıman özelliği Uzmman tarafından incelenmelidir.",
 );
 ...
 static final tipOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Trafo tipi (yağlı/kuru) belirlenememiştir. Yağlı tip trafolar daha yüksek yangın riski taşıdığından tip tespiti kritiktir.",
 );
 ...
 static final cukurOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Yağlı trafo altında toplama çukuru mevcuttur.",
 );
 ...
 static final cukurOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Yağlı trafo altında yağ toplama çukuru olup olmadığı tespit edilememiştir.",
 );
 ...
 static final sondurmeOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Trafo odasındaki otomatik söndürme/algılama sistemlerinin varlığı veya çalışabilirliği belirsizdir.",
 );
 ...
 static final cevreOptionD = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Trafo odası çevresindeki su tesisatı veya ıslak hacim riskleri gözlemlenememiştir.",
 );
}
...
class Bolum32Content {
 ...
 static final yapiOptionD = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Jeneratör odasının yapısal özellikleri ve kapı dayanımı bilinmiyor. Yangın ve zehirli gaz yayılımı riskine karşı bu alanın teknik incelemesi yapılmalıdır.",
 );
 ...
 static final yakitOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Yakıt depolama yöntemi güvenli gözükmektedir.",
 );
 static final yakitOptionB = ChoiceResult(
  label: "32-2-B",
 ...
 static final yakitOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Jeneratör yakıtının depolanma şekli bilinmiyor. Yanıcı sıvıların açıkta saklanması büyük bir patlama riskidir, kontrol edilmelidir.",
 );
 ...
 static final cevreOptionA = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "OLUMLU: Çevresel su riski bulunmamaktadır.",
 );
 static final cevreOptionB = ChoiceResult(
  label: "32-3-B",
 ...
 static final cevreOptionD = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Jeneratör odası çevresindeki tesisat riskleri bilinmiyor. Olası bir su sızıntısının elektrik sistemine zarar verip vermeyeceği denetlenmelidir.",
 );
 ...
 static final egzozOptionA = ChoiceResult(
  ...
  reportText:
        "OLUMLU: Egzoz gazı bina dışına atılmaktadır.",
 );
 ...
 static final egzozOptionC = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "BİLMİYORUM: Jeneratör egzoz tahliye sistemi bilinmiyor. Karbonmonoksit zehirlenmesi riskine karşı egzozun bina dışına verildiğinden emin olunmalıdır.",
 );
}
...
class Bolum33Content {
 ...
 static final normalKatYetersiz = ChoiceResult(
  ...
  reportText:
        "KRİTİK RİSK: Normal katlardaki mevcut çıkış sayısı, hesaplanan kullanıcı yükü için yetersizdir. İlave çıkış gereklidir.",
  adviceText:
 ...
 static final zeminKatYetersiz = ChoiceResult(
  ...
  uiSubtitle: "Çıkış sayısı eksik.",
  reportText:
        "KRİTİK RİSK: Zemin kattaki mevcut çıkış sayısı, hesaplanan kullanıcı yükü için yetersizdir.",
 );
 ...
 static final bodrumKatYetersiz = ChoiceResult(
  ...
  uiSubtitle: "Çıkış sayısı eksik.",
  reportText:
        "KRİTİK RİSK: Bodrum katlardaki mevcut çıkış sayısı, hesaplanan kullanıcı yükü için yetersizdir.",
 );
...
class Bolum34Content {
 ...
 static final zeminOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Ticari alanların bina koridoruna açılması, kaçış yolundaki yoğunluğu artırır. Uzman görüşü alınması tavsiye edilir.",
 );
...
class Bolum35Content {
 ...
 static final tekYonOptionA = ChoiceResult(
  ...
  reportText:
        "(Girilen değere göre otomatik hesaplanır)",
 );
 ...
 static final tekYonOptionC = ChoiceResult(
  ...
  reportText:
        "KRİTİK RİSK: Tek yön kaçış mesafesi sınırın üzerindedir. Yangın anında merdivene ulaşmak uzun sürebilir.",
 );
 static final tekYonOptionD = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Kaçış mesafesi bilinmiyor. Bu mesafe, insanların tahliye süresini belirleyen en önemli faktördür. Ölçüm yapılmalıdır.",
 );
 ...
 static final ciftYonOptionD = ChoiceResult(
  ...
  uiSubtitle: "Mesafeyi tahmin edemiyorum.",
  reportText:
        "BİLMİYORUM: Kaçış mesafesi bilinmiyor. Ölçüm yapılmalıdır.",
 );
 ...
 static final cikmazOptionA = ChoiceResult(
  ...
  uiSubtitle: "",
  reportText:
        "OLUMLU: Daire çıkmaz koridor üzerinde değildir.",
 );
 ...
 static final cikmazMesafeOptionD = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Çıkmaz koridor mesafesi bilinmiyor. Ölçüm yapılmalıdır.",
 );
}
...
class Bolum36Content {
 ...
 static final cikisKatiOptionB = ChoiceResult(
  ...
  reportText:
        "BİLGİ: Binadan dış havaya çıkış Normal Kattan sağlanmaktadır.",
 );
 ...
 static final cikisKatiOptionC = ChoiceResult(
  ...
  reportText:
        "BİLGİ: Binadan dış havaya çıkış Bodrum Kattan sağlanmaktadır.",
 );
 ...
 static final disMerdOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Dış merdiven çevresindeki açıklıklar bilinmiyor.",
 );
 ...
 static final konumOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Merdiven konumları net değil.",
 );
 ...
 static final genislikBilinmiyor = ChoiceResult(
  ...
  uiSubtitle: "Ölçüm yapılamadı.",
  reportText:
        "BİLMİYORUM: Kaçış yolu genişliği ölçülemedi.",
 );
 ...
 static final kapiTipiOptionA = ChoiceResult(
  ...
  reportText:
        "BİLGİ: Çıkış kapısı tek kanatlıdır.",
 );
 static final kapiTipiOptionB = ChoiceResult(
  ...
  reportText:
        "BİLGİ: Çıkış kapısı çift kanatlıdır.",
 );
 static final kapiTipiOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Çıkış kapısı tipi bilinmiyor.",
 );
 ...
 static final kapiGenislikBilinmiyor = ChoiceResult(
  ...
  uiSubtitle: "Ölçüm yapılamadı.",
  reportText:
        "BİLMİYORUM: Çıkış kapısı net genişliği bilinmiyor.",
 );
 ...
 static final gorunurlukOptionC = ChoiceResult(
  ...
  reportText:
        "BİLMİYORUM: Çıkışların erişilebilirliği tespit edilememiştir.",
 );
}
