...
class Bolum6Content {
  ...
  static final otoparkAcik = ChoiceResult(
    ...
    uiTitle: "Otoparkın karşılıklı İKİ cephesi AÇIK.",
    uiSubtitle: "Doğal havalandırma var.",
    reportText:
...
class Bolum11Content {
  ...
  static final mesafeOptionA = ChoiceResult(
    ...
    uiSubtitle:
        "İtfaiye aracı binanın tüm cephelerine 45 metre içerisinde ulaşıyor.",
    reportText:
  ...
  static final mesafeOptionB = ChoiceResult(
    ...
    uiTitle: "Evet, aşıyor.",
    uiSubtitle:
        "İtfaiye aracı binanın tüm cephelerine 45 metre içerisinde ulaşamıyor.",
    reportText:
  ...
  static final zayifNoktaOptionC = ChoiceResult(
    label: "11-3-C",
    uiTitle: "Bilmiyorum.",
    uiSubtitle: "",
    reportText:
        "BİLİNMİYOR: İtfaiye erişimini engelleyen duvarlarda zayıflatılmış geçiş bölgesi olup olmadığı bilinmemektedir. İtfaiyenin binaya yaklaşma imkanları sahada kontrol edilmelidir.",
    level: RiskLevel.unknown,
  );
}
...
class Bolum12Content {
  ...
  static final ahsapOptionC = ChoiceResult(
    label: "12-C (Ahşap)",
    uiTitle: "Bilmiyorum.",
    uiSubtitle: "",
    reportText:
        "BİLİNMİYOR: Ahşap taşıyıcı elemanların kesit kalınlıkları bilinmiyor. Eğer kesitler inceyse yangın anında çökme riski yüksektir.",
    level: RiskLevel.unknown,
  );
  ...
  static final yigmaOptionC = ChoiceResult(
    label: "12-C (Yığma)",
    uiTitle: "Bilmiyorum.",
    uiSubtitle: "",
    reportText:
        "BİLİNMİYOR: Yığma taşıyıcı duvarların kalınlığı bilinmemektedir. Taşıyıcı duvarların en az 19 cm kalınlığında olması şarttır.",
    level: RiskLevel.unknown,
  );
}
...
class Bolum13Content {
  static final otoparkOptionA = ChoiceResult(
    ...
    uiTitle: "Yangın dayanımlı.",
    uiSubtitle: "Duman sızdırmaz ve bırakınca kendiliğinden kapanıyor.",
    reportText:
  ...
  static final kazanOptionB = ChoiceResult(
    ...
    uiTitle: "Hayır.",
    uiSubtitle:
        "Duvarları veya kapısı yangın dayanımsız (sac, demir, plastik, aluminyum, ahşap, cam), kapı içeriye doğru açılıyor.",
    reportText:
  ...
  static final kazanOptionC = ChoiceResult(
    ...
    uiTitle: "Kazan dairesi binadan uzak, ayrı bir yerde.",
    uiSubtitle: "",
    reportText:
  ...
  static final asansorOptionC = ChoiceResult(
    ...
    uiSubtitle: "",
    reportText:
        "BİLİNMİYOR: Kapı özellikleri bilinmiyor, duvarlarıyla birlikte kapısının da yangına dayanıklı olması gereklidir. Asansör kat kapılarının yangın dayanım test raporu incelenerek uygunluklarına karar verilir. Ayrıca binada asansör makine dairesi varsa bu odanın duvarları ve kapısı yangın dayanımlı olmalıdır.",
    level: RiskLevel.unknown,
  );
  ...
  static final trafoOptionB = ChoiceResult(
    ...
    uiSubtitle:
        "Duvarları veya kapısı yangın dayanımsız (sac, demir, plastik, aluminyum, ahşap, cam).",
    reportText:
        "UYARI: Yağlı tip trafo var ise, bu trafo odası yüksek yangın riski taşır. Kapı ve duvarların yangın dayanım özellikli olması şarttır. Mevcut kapı bu riski karşılamamaktadır.",
    level: RiskLevel.warning,
  );
...
class Bolum15Content {
  static final kaplamaOptionA = ChoiceResult(
    label: "15-1-A",
    uiTitle: "Ahşap parke, laminat, vinil, karo halı vb.",
    uiSubtitle: "Yanıcı kaplama",
    reportText:
  ...
  static final kaplamaOptionD = ChoiceResult(
    label: "15-1-D",
    uiTitle: "Farklı zemin kaplama tipleri mevcut.",
    uiSubtitle: "",
    reportText:
  ...
  static final yalitimOptionA = ChoiceResult(
    label: "15-2-A",
    uiTitle: "Hayır, ısı yalıtımı yok.",
  ...
  static final yalitimOptionBYanmaz = ChoiceResult(
    label: "15-2-B",
    uiTitle: "Evet var. Camyünü, taşyünü vb.",
    uiSubtitle: "Yanmaz malzeme",
    reportText:
        "OLUMLU: Döşeme yalıtımında camyünü, taşyünü veya benzeri yanmaz malzeme kullanılmıştır. Yangın yayılımı açısından ek risk teşkil etmemektedir.",
    level: RiskLevel.positive,
  );

  static final yalitimOptionB = ChoiceResult(
    label: "15-2-C",
    uiTitle: "Evet var. XPS, EPS, köpük vb.",
    uiSubtitle: "Yanıcı malzeme",
    reportText: "UYARI: Yanıcı yalıtım malzemesi kullanımı tespit edilmiştir.",
    adviceText:
  ...
  static final tesisatOptionA = ChoiceResult(
    label: "15-4-A",
    uiTitle: "Beton, harç, mastik vb. ile",
    uiSubtitle: "Yangına dayanıklı malzeme ile",
    reportText:
  ...
  static final tesisatOptionB = ChoiceResult(
    label: "15-4-B",
    uiTitle: "Poliüretan (sarı) köpük ile",
    uiSubtitle: "Tesisat geçişleri boşluklu.",
    reportText:
  ...
  static final tesisatOptionC = ChoiceResult(
    label: "15-4-C",
    uiTitle: "Karma",
    uiSubtitle: "Kısmen yalıtımlı kısmen yalıtımsız.",
    reportText:
...
class Bolum17Content {
  static final kaplamaOptionA = ChoiceResult(
    ...
    uiTitle: "Kiremit, metal kenet, beton, taş vb.",
    uiSubtitle: "Yanmaz malzeme",
    reportText:
  ...
  static final isiklikOptionA = ChoiceResult(
    ...
    uiSubtitle: "",
    reportText:
        "OLUMLU: Çatıda ışıklık olmaması sebebiyle bu konuda herhangi bir incelemeye gerek bulunmamaktadır.",
    level: RiskLevel.positive,
  );
  ...
  static final isiklikBilinmiyor = ChoiceResult(
    label: "17-4-B-BILINMIYOR (Işıklık Malzeme)",
    uiTitle: "Bilmiyorum.",
    uiSubtitle: "",
    reportText:
...
class Bolum18Content {
  static final duvarOptionA = ChoiceResult(
    label: "18-1-A (Duvar)",
    uiTitle: "Sadece sıva ve boya.",
    uiSubtitle: "Duvarlarda ekstra bir kaplama malzemesi yoktur.",
    reportText:
        "OLUMLU: Duvar yüzeylerinde yanıcı kaplama bulunmamaktadır. Bu durum yangın güvenliği açısından olumludur.",
    level: RiskLevel.positive,
  );

  static final duvarOptionB = ChoiceResult(
    label: "18-1-B (Duvar)",
    uiTitle: "Ahşap, plastik, strafor vb. kullanılmış.",
    uiSubtitle: "",
    reportText:
        "Binanızın Yüksek Bina olup olmamasına göre farklı sınıfta ürünler kullanılabilir. Binanızda kullanılabilecek minimum yangına tepki sınıfı aşağıda belirtilmiştir. ",
    level: RiskLevel.positive,
  );
  ...
  static final boruOptionB = ChoiceResult(
    label: "18-2-B (Boru)",
    uiTitle: "Plastik boru ve yangın dayanımlı kelepçe kullanılmış.",
    uiSubtitle: "",
    reportText:
  ...
  static final boruOptionC = ChoiceResult(
    label: "18-2-C (Boru)",
    uiTitle: "Yalnızca plastik boru kullanılmış.",
    uiSubtitle: "Yangın dayanımlı kelepçe yok.",
    reportText:
        "UYARI: Standart plastik borular yangın anında eriyerek yok olur ve döşemede delik açılır. Bu delikten alevler üst kata geçebilir.",
    adviceText:
        "Mevcut plastik boruların kat geçişlerinde, boru çapına uygun, onaylı yangın durdurucu kelepçe veya sargıların uygulanması önerilir.",
    level: RiskLevel.warning,
  );
...
class Bolum19Content {
  ...
  static final engelOptionB = ChoiceResult(
    label: "19-1-B",
    uiTitle: "Eşya, mobilya, çöp vb. var.",
    uiSubtitle: "Kaçış yolu tıkalı.",
    reportText:
  ...
  static final levhaOptionA = ChoiceResult(
    label: "19-2-A",
    uiTitle: "Evet, tüm çıkışlarda var.",
    uiSubtitle: "Ledli, ışıklı.",
    reportText:
        "OLUMLU: Acil durum yönlendirme işaretleri mevcuttur. Yönlendirme işaretlerinin yerleşim ve tip uygunluklarının kontrol edilmesi önerilir.",
    level: RiskLevel.positive,
  );
  ...
  static final levhaOptionB = ChoiceResult(
    ...
    uiSubtitle: "",
    reportText:
        "KRİTİK RİSK: Binada acil durum yönlendirme işaretleri bulunmamaktadır. Birden fazla çıkışı olan tüm yapılarda acil durum yönlendirme işaretleri bulunması zorunludur.",
    level: RiskLevel.critical,
  );

  static final levhaOptionC = ChoiceResult(
    label: "19-2-C",
    uiTitle: "Var ama bazıları arızalı.",
    uiSubtitle: "",
    reportText:
        "UYARI: Yönlendirme işaretlemeleri mevcut ancak çalışır durumda değildir. Acil durumda bu işaretlerin çalışır durumda olması önemlidir. Birden fazla çıkışı olan tüm yapılarda acil durum yönlendirme işaretleri bulunması zorunludur.",
    level: RiskLevel.warning,
  );

  static final levhaOptionD = ChoiceResult(
    label: "19-2-D",
    uiTitle: "Bilmiyorum.",
    uiSubtitle: "",
    reportText:
        "BİLİNMİYOR: Acil durum yönlendirme işaretlerinin varlığı veya çalışma durumu bilinmiyor. Kontrol edilmelidir.",
    level: RiskLevel.unknown,
  );

  static final yanilticiOptionA = ChoiceResult(
    label: "19-3-A",
    uiTitle: "Yok, çıkışı kolayca bulabilirim.",
    uiSubtitle: "",
    reportText:
        "OLUMLU: Kaçış yollarında kullanıcıyı yanıltacak kapı bulunmamaktadır. Tahliye kolayca gerçekleştirilebilir.",
    level: RiskLevel.positive,
  );
  ...
  static final yanilticiOptionC = ChoiceResult(
    label: "19-3-C",
    uiTitle: "Bilmiyorum.",
    uiSubtitle: "",
    reportText:
        "BİLİNMİYOR: Kaçış yollarında yanıltıcı kapı olup olmadığı bilinmiyor. Yanıltıcı kapılar tahliye anında paniğe ve gecikmeye neden olabilir.",
    level: RiskLevel.unknown,
  );
  ...
  static final etiketOptionB = ChoiceResult(
    ...
    adviceText:
        "Yanıltıcı kapıların üzerinde mahalin adı yazmalı veya 'ÇIKIŞ DEĞİLDİR' etiketi bulunmalıdır.",
    level: RiskLevel.warning,
  );
...
class Bolum20Content {
  ...
  static final havalandirmaOptionA = ChoiceResult(
    ...
    uiSubtitle: "",
    reportText:
        "OLUMLU: Merdivenlerde doğal havalandırma (pencere/menfez) imkanı mevcuttur. Yönetmelik gereği, binadaki merdivenlerin tamamında doğal veya mekanik havalandırma (basınçlandırma) tesis edilmesi şarttır.",
    level: RiskLevel.positive,
  );
...
class Bolum21Content {
  ...
  static final esyaOptionD = ChoiceResult(
    label: "21-4-D",
    uiTitle: "Bilmiyorum.",
    uiSubtitle: "",
    reportText:
...
class Bolum23Content {
  ...
  static final konumOptionA = ChoiceResult(
    label: "23-3-A (Konum)",
    uiTitle: "Koridora veya hole doğru açılıyor.",
    uiSubtitle: "",
    reportText:
        "OLUMLU: Asansör kapıları kat koridoruna veya holüne doğru açılmaktadır. Yönetmelik açısından yeterlidir.",
    level: RiskLevel.positive,
  );
...
class Bolum27Content {
  ...
  static final yonOptionD = ChoiceResult(
    label: "27-2-D",
    uiTitle: "Farklı tip kapılar mevcut.",
    uiSubtitle: "",
    reportText:
  ...
  static final kilitOptionD = ChoiceResult(
    label: "27-3-D",
    uiTitle: "Farklı tip kilitler mevcut.",
    uiSubtitle: "",
    reportText:
  ...
  static final dayanimOptionA = ChoiceResult(
    label: "27-4-A",
    uiTitle: "Yangın dayanımlı, duman sızdırmaz, kendiliğinden kapanıyor.",
    uiSubtitle: "",
    reportText:
  ...
  static final dayanimOptionB = ChoiceResult(
    label: "27-4-B",
    uiTitle:
        "Yangın dayanımlı, duman sızdırmaz ancak kendiliğinden kapanmıyor.",
  ...
  static final dayanimOptionC = ChoiceResult(
    label: "27-4-C",
    uiTitle: "Yangın dayanımsız plastik, demir, ahşap, cam vb.",
    uiSubtitle: "",
    reportText:
        "KRİTİK RİSK: Yangın merdiveni kapıları yanıcı malzemeden yapılamaz. Bu Uygulama'nın Bölüm-14'ünde yer alan şaft kapağı yangın dayanım süresiyle aynı dayanım süresi alınabilir. Yangın kapısı en az 60 dk yangına dayanıklı olmalıdır.",
    level: RiskLevel.critical,
  );
  ...
  static final dayanimOptionD = ChoiceResult(
    label: "27-4-D",
    uiTitle: "Karma.",
    uiSubtitle: "Farklı tipte kapılar mevcut.",
    reportText:
        "KRİTİK RİSK: Kaçış merdivenine açılan kapıların bir kısmının yangına dayanıksız (ahşap, plastik, cam vb.) olması, yangın kompartıman bütünlüğünü bozar. Tüm kapıların sertifikalı yangın kapısı olması zorunludur.",
    level: RiskLevel.critical,
  );
  ...
  static final dayanimOptionE = ChoiceResult(
    ...
    uiSubtitle: "",
    reportText:
        "BİLİNMİYOR: Kaçış yolu üzerindeki kapıların özellikleri bilinmiyor. Yangın Güvenlik Uzmanı tarafından yerinde inceleme yapılması önerilir.",
    level: RiskLevel.unknown,
  );
}
...
class Bolum28Content {
  ...
  static final mesafeOptionD = ChoiceResult(
    label: "28-2-D (Mesafe)",
    uiTitle: "Bilmiyorum.",
    uiSubtitle: "",
    reportText:
        "BİLİNMİYOR: Daire içi kaçış mesafesi bilinmiyor. Özellikle büyük dairelerde bu mesafe yönetmelik limitlerini aşabilir.",
    level: RiskLevel.unknown,
  );
...
class Bolum29Content {
  ...
  static final otoparkOptionA = ChoiceResult(
    label: "29-1-A",
    uiTitle: "Sadece taşıtlar var, alan düzenli.",
    uiSubtitle: "",
    reportText:
  ...
  static final otoparkOptionB = ChoiceResult(
    label: "29-1-B",
    uiTitle: "Lastik, mobilya vb. eşya yığını var.",
    uiSubtitle: "",
    reportText:
        "UYARI: Otopark alanlarında araçlar haricinde hiçbir yanıcı malzeme (kışlık lastik, koli, eski eşya vb.) depolanmamalıdır. Taşıt yangınlarında bu malzemeler yangını hızla büyüterek kontrol edilemez hale getirir.",
    level: RiskLevel.warning,
  );
  static final otoparkOptionC = ChoiceResult(
    label: "29-1-C",
    ...
    uiSubtitle: "",
    reportText:
        "BİLİNMİYOR: Otoparkın temizlik durumu bilinmiyor. Araçların yanına istiflenen eski lastikler veya eşyalar, küçük bir araç yangınını tüm binayı saracak bir felakete dönüştürebilir.",
    level: RiskLevel.unknown,
  );
  ...
  static final kazanOptionA = ChoiceResult(
    label: "29-2-A",
    uiTitle: "Sadece kazanlar var, alan düzenli.",
    uiSubtitle: "",
    reportText:
        "OLUMLU: Kazan dairesinde gereksiz yanıcı madde bulunmamaktadır. Bu anlamda Yönetmelik talebi karşılanıyor.",
    level: RiskLevel.positive,
  );
  static final kazanOptionB = ChoiceResult(
    label: "29-2-B",
    uiTitle: "Gereksiz eşyalar var.",
    uiSubtitle: "",
    reportText:
  ...
  static final kazanOptionC = ChoiceResult(
    ...
    uiSubtitle: "",
    reportText:
        "BİLİNMİYOR: Kazan dairesinin içi bilinmiyor. Bu alan binadaki en riskli alanlardan biridir. Kazan dairesinde detaylı inceleme yapılarak Yönetmelik ve ilgili standartlara göre ne durumda olduğu kontrol edilmelidir.",
    level: RiskLevel.unknown,
  );
  ...
  static final panoOptionA = ChoiceResult(
    ...
    reportText:
        "OLUMLU: Elektrik pano odası temizdir. Yönetmelik açısından içerideki elektrikli ekipmanlara göre önlem alınması yeterli kabul edilir.",
    level: RiskLevel.positive,
  );
  static final panoOptionB = ChoiceResult(
    label: "29-6-B",
    uiTitle: "Evet.",
    uiSubtitle: "Temizlik malzemesi, süpürge, kağıt vb. saklanıyor.",
    reportText:
        "UYARI: Pano odaları kesinlikle boş olmalıdır. Elektrik kontağı anında yanıcı malzemeleri tutuşturur.",
    adviceText:
        "Elektrik pano odaları temizlik malzemesi deposu değildir. Paspas, süpürge, kağıt havlu gibi malzemeler, oluşabilecek en ufak bir kıvılcımda tutuşarak ana elektrik dağıtım sistemini devre dışı bırakabilir.",
    level: RiskLevel.warning,
  );
  static final panoOptionC = ChoiceResult(
    ...
    uiSubtitle: "",
    reportText:
        "BİLİNMİYOR: Elektrik odasının içi bilinmiyor. Pano odaları yangınların en sık başladığı yerlerdir. İçeride unutulan bir yanıcı eşyalar, küçük bir ark (kıvılcım) sonucu büyük bir yangını başlatabilir.",
    level: RiskLevel.unknown,
  );
  ...
  static final trafoOptionB = ChoiceResult(
    label: "29-7-B",
    uiTitle: "Havalandırma menfezleri kapalı, yok veya içeride eşya var.",
    uiSubtitle: "",
    reportText:
  ...
  static final copOptionA = ChoiceResult(
    ...
    reportText: "OLUMLU: Çöp odası temiz ve düzenli.",
    level: RiskLevel.positive,
  );
  static final copOptionB = ChoiceResult(
    label: "29-9-B",
...
class Bolum30Content {
  ...
  static final konumOptionC = ChoiceResult(
    label: "30-1-C",
    uiTitle: "Binadan tamamen ayrı, uzak bir yerde.",
    uiSubtitle: "",
    reportText:
        "OLUMLU: Kazan dairesi bina dışındadır. Mevcut durumda ana bina için büyük risk teşkil etmeyebilir.",
    level: RiskLevel.positive,
  );
  ...
  static final kapasiteBilinmiyorOption = ChoiceResult(
    label: "30-2-C (Kapasite)",
    uiTitle: "Bilmiyorum.",
    uiSubtitle: "",
    reportText:
        "BİLİNMİYOR: Kazan dairesinin ısıl kapasitesi eğer 350kw 'ın üzerindeyse veya mahal alanı 100 m2 'nin üzerindeyse (alternatif yönde konumlanan) çift çıkış kapısı gereklidir.",
    level: RiskLevel.unknown,
  );
  ...
  static final kapiOptionA = ChoiceResult(
    ...
    uiSubtitle: "",
    reportText:
        "KRİTİK RİSK: 350 kW üzeri kapasiteli büyük kazan dairesinde Yönetmeliğe göre en az 2 adet çıkış kapısı zorunludur.",
    level: RiskLevel.critical,
  );
  static final kapiOptionB = ChoiceResult(
    label: "30-3-B",
...
class Bolum32Content {
  ...
  static final yakitOptionA = ChoiceResult(
    ...
    reportText:
        "OLUMLU: Yakıt depolama yöntemi, tankla ilgili önlemler alınmış ise güvenlidir.",
    level: RiskLevel.positive,
  );
  static final yakitOptionB = ChoiceResult(
    label: "32-2-B",
  ...
  static final cevreOptionD = ChoiceResult(
    ...
    uiSubtitle: "",
    reportText:
        "BİLİNMİYOR: Jeneratör odası çevresindeki tesisat riskleri bilinmiyor. Olası bir su sızıntısının elektrik sistemine zarar verip vermeyeceği sahada muayene edilmelidir.",
    level: RiskLevel.unknown,
  );
...
class Bolum36Content {
  ...
  static final disMerdOptionA = ChoiceResult(
    label: "36-1-A",
    uiTitle: "Hayır, merdiven etrafındaki duvarlar tamamen sağır (kapalı).",
  ...
  static final disMerdOptionB = ChoiceResult(
    label: "36-1-B",
    uiTitle: "Evet, merdivenin hemen çevresinde pencereler veya kapılar var.",
    uiSubtitle: "",
    reportText:
  ...
  static final konumOptionC = ChoiceResult(
    ...
    uiSubtitle: "",
    reportText:
        "BİLİNMİYOR: Merdiven konumları net değil. Mimari proje üzerinde veya sahada merdivenler arasında mesafe ölçümü yapılarak Yönetmelik taleplerini karşılayıp karşılamadıkları tespit edilmelidir. ",
    level: RiskLevel.unknown,
  );
...
class AppDefinitions {
  ...
  static String getSectionTitle(int id) {
    switch (id) {
      case 1:
        return "Yapı Ruhsat Tarihi";
      case 2:
        return "Taşıyıcı Sistem";
      case 3:
        return "Kat Yükseklik Bilgileri";
      case 4:
        return "Bina Yükseklik Sınıfı";
      case 5:
        return "Kat Alan Bilgileri";
      case 6:
      ...
      case 28:
        return "Daire İçi Kaçış Mesafesi";
      case 29:
        return "Yanıcı Madde Varlığı";
      case 30:
      ...
      case 33:
        return "Kullanıcı Yükü";
      case 34:
        return "Ticari Alanlar";
      case 35:
        return "Kaçış Mesafesi";
      case 36:
