...
class Bolum8Model {
  ...
  factory Bolum8Model.fromMap(Map<String, dynamic> map) {
    ...
    if (label == Bolum8Content.ayrikNizam.label)
      return Bolum8Model(secim: Bolum8Content.ayrikNizam);
    if (label == Bolum8Content.bitisikNizam.label)
      return Bolum8Model(secim: Bolum8Content.bitisikNizam);
    return Bolum8Model();
  }
}
